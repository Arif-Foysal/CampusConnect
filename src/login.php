...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
    if(empty(trim($_POST['student_id'])) || empty(trim($_POST['password'])))
    {
        $err = "Please enter student_id + password";
    }
    else{
      ...
      <form name="signupForm" action="" method="post" class="mt-8 grid grid-cols-6 gap-6">
        ...
        <div class="col-span-6">
          ...
          />
            ...
            <div class="col-span-6">
          <label for="student_id" class="block text-sm font-medium text-gray-700"> Password </label>
          <input
            type="password"
            id="password"
            name="password"
